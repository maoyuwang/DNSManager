...
public class EditRecordForm extends JDialog {
    ...
    public EditRecordForm(RecordForm _reCordFm, int _index, Record rec) {
        ...
        this.index = _index;
        this.tFName.setText(rec.name);
        this.tFType.setText(rec.type);
        this.tFValue.setText(rec.value);
        this.tDomain.setText(rec.domain);
        init();
    }

    private void onOK() {
        reCordFm.UpdateRecord(new Record(tDomain.getText(), tFType.getText(), tFName.getText(), tFValue.getText()), index);
        dispose();
    }
